...
[![LabVIEW CI dashboard](https://img.shields.io/badge/LabVIEW%20CI-dashboard-2ea44f)](https://elijah286.github.io/challenge-of-champions/)

LabVIEW CI runs on every pull request. See the [**CI dashboard**](https://elijah286.github.io/challenge-of-champions/) for build status, VI Analyzer results, VI diffs, and mass-compile reports.
